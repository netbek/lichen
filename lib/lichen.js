...
var findFile = require('./util').findFile;
var fs = require('fs-extra');
var getModifiers = require('./util').getModifiers;
var multiGlobAsync = require('./util').multiGlobAsync;
var multiGlobSync = require('./util').multiGlobSync;
...
var stripModifiers = require('./util').stripModifiers;
